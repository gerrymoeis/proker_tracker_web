...
export async function GET(
  ...
  try {
    ...
    console.log(`Security API: User ${decoded.id} is accessing settings for user ${userId}`);
    ...
    */
    ...
    console.log(`Security Settings API: Fetching settings for user ID ${userId}`);
...
export async function PUT(
  ...
  try {
    ...
    console.log(`Security Settings API: Updating settings for user ID ${userId}`);
    ...
    return NextResponse.json(
      { 
        message: 'Berhasil memperbarui pengaturan keamanan',
        settings: body
      },
      { status: 200 }
    );
    ...
    console.error('Error in security settings API:', error);
    return NextResponse.json(
      { error: 'Terjadi kesalahan saat memperbarui pengaturan keamanan' },
      { status: 500 }
    );
  }
}
