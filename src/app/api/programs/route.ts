 ...
 *               status:
 *                 type: string
 *                 enum: [belum_dimulai, dalam_progres, selesai, dibatalkan]
 ...
 *               department_id:
 *                 type: integer
 *                 description: Department ID associated with the program
 *               pic_id:
 *                 type: integer
 *                 description: Person in charge (user ID) for the program
 *               budget:
 *                 type: integer
 *                 description: Program budget in IDR
 *     responses:
 *       201:
 *         description: Program created successfully
 *         content:
